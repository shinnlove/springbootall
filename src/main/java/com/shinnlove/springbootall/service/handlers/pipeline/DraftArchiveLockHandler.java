 ...
 * 
 * @author Tony Zhao
 * @version $Id: DraftArchiveLockHandler.java, v 0.1 2022-05-05 9:04 PM Tony Zhao Exp $$
 */
@Service
public class DraftArchiveLockHandler implements ActionHandler<PickupMessage, Integer> {

    private static final Logger logger = LoggerFactory.getLogger(DraftArchiveLockHandler.class);

    @Override
    public Integer process(ActionChain chain, ProcessContext<PickupMessage> context) {

        LoggerUtil.warn(logger, "DraftArchiveLockHandler handler executed");
