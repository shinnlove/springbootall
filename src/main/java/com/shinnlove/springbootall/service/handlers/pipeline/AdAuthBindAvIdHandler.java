 ...
 * 
 * @author Tony Zhao
 * @version $Id: AdAuthBindAvIdHandler.java, v 0.1 2022-04-29 2:33 PM Tony Zhao Exp $$
 */
@Service
public class AdAuthBindAvIdHandler implements ActionHandler<PickupMessage, Integer> {

    private static final Logger logger = LoggerFactory.getLogger(AdAuthBindAvIdHandler.class);
